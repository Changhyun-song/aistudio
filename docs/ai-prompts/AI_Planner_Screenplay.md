...
- 관계 중심성 — 에피소드가 관계 동력으로 진행되는가
- 일상 배치 — EP1에 일상이 70% 이상인가, small_moment가 있는가
- 자연스러움 — 우연/편의적 전환 없이 캐릭터 선택이 사건을 만드는가
...
- EP1 일상 부재 → 캐릭터 호감 형성 불가
- 관계가 아닌 설정이 에피소드를 지배 → 감정 몰입 실패
- 우연/편의적 전환 다수 → 자연스러움 회복 불가
...
### 패턴 4: 관계/일상 부재
- **증상**: relationship_and_everyday 낮음
- **진단**: EP1의 일상 비율 확인, 관계 대화 vs 설정 전달 비율, 우연 사용 횟수 확인
- **지시**: EP1에 일상 장면 추가 (예: "EP1 scene 1~3을 캐릭터 매력이 보이는 일상으로 재구성, 소재는 scene 4부터 본격 도입"), small_moment 삽입
